...
class VideoCompressUtils {
  ...
  /// 快速压缩（使用默认配置）
  static Future<void> quickCompress(
    String inputPath, {
    Function(double)? onProgress,
    Function(VideoCompressResult)? onSuccess,
    Function(VideoCompressResult)? onError,
  ...
  /// 高质量压缩
  static Future<void> highQualityCompress(
    String inputPath, {
    Function(double)? onProgress,
    Function(VideoCompressResult)? onSuccess,
    Function(VideoCompressResult)? onError,
  ...
  /// 低质量压缩（文件更小）
  static Future<void> lowQualityCompress(
    String inputPath, {
    Function(double)? onProgress,
    Function(VideoCompressResult)? onSuccess,
    Function(VideoCompressResult)? onError,
  ...
  /// 批量压缩
  static Future<void> batchCompress(
