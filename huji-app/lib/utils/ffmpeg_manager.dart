...
class FFmpegManager {
  ...
  static Future<bool> initialize() async {
    ...
    try {
      ...
      if (result.isSuccess) {
        ...
        if (FFmpegErrorUtils.isCancelledReturnCode(result.returnCode)) {
          _logger.i('FFmpeg初始化已取消');
          return false;
        }
        _logger.e(
          'FFmpeg初始化失败',
  ...
  static Future<String?> getVersion() async {
    try {
      ...
      _logger.e('获取FFmpeg版本失败: $e', stackTrace);
      return null;
    }
  }
    ...
    try {
      ...
      if (runnerResult.isSuccess) {
        ...
        _logger.e(
          ...
          StackTrace.current,
          FFmpegErrorUtils.buildCommandException(
            operation: 'FFmpeg命令执行',
            returnCode: runnerResult.returnCode,
            command: command,
            logs: logs,
          ),
        );
  ...
  static Future<List<String>> getSupportedCodecs() async {
    try {
      ...
      _logger.e('获取编码器列表失败: $e', stackTrace);
      return [];
    }
  }
  ...
  static Future<List<String>> getSupportedFormats() async {
    try {
      ...
      _logger.e('获取格式列表失败: $e', stackTrace);
      return [];
    }
  }
  ...
  static Future<MediaInfo?> getMediaInfo(String filePath) async {
    try {
      ...
      _logger.e('获取媒体信息失败: $e', stackTrace);
      return null;
    }
  }
  ...
  static MediaInfo? _parseMediaInfo(String logs) {
    try {
      ...
      _logger.e('解析媒体信息失败: $e', stackTrace);
      return null;
    }
  }
  ...
  static Future<void> cancel() async {
    try {
      ...
      _logger.e('取消FFmpeg任务失败: $e', stackTrace);
    }
  }
  ...
  static Future<String?> getConfiguration() async {
    try {
      ...
      _logger.e('获取FFmpeg配置失败: $e', stackTrace);
      return null;
    }
  }
  ...
  static Future<bool> hasFeature(String feature) async {
    try {
      ...
      _logger.e('检查FFmpeg功能失败: $e', stackTrace);
      return false;
    }
  }
}
