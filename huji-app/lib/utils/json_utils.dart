...
dynamic _formatCollectionString(dynamic value) {
  if (value is String) {
    try {
      // Only auto-decode JSON arrays, not objects.
      // Objects may have custom fromJson converters that expect a String
      // (e.g. VideoClipConfigReqVo), so decoding here would cause
      // "Map is not a subtype of String" in the generated deserializer.
