...
class _DropdownDisplay extends StatelessWidget {
  final String value;
  const _DropdownDisplay({required this.value});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.arrow_drop_down, size: 18, color: DesktopTheme.textDim),
        ],
      ),
    );
  }
