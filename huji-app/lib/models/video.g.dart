...
const _$VideoRecordTypeEnumEnumMap = {
  ...
  VideoRecordTypeEnum.saved: 'saved',
};
...
SavedVideoRecord _$SavedVideoRecordFromJson(Map<String, dynamic> json) =>
    SavedVideoRecord(
        id: json['id'] as String,
        sportType: $enumDecode(_$SportTypeEnumMap, json['sportType']),
        filePath: json['filePath'] as String?,
        ...
        videoProcessType: $enumDecodeNullable(
      ...
      ..clipMode = $enumDecode(_$ClipModeEnumMap, json['clipMode'])
      ..type = $enumDecode(_$VideoRecordTypeEnumEnumMap, json['type']);

Map<String, dynamic> _$SavedVideoRecordToJson(SavedVideoRecord instance) =>
    <String, dynamic>{
      'id': instance.id,
      'processStatus':
          _$LocalVideoProcessStatusEnumEnumMap[instance.processStatus]!,
