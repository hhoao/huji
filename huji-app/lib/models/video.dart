...
abstract class LocalVideoRecord {
  ...
  factory LocalVideoRecord.fromJson(Map<String, dynamic> json) {
    ...
    switch (type) {
      ...
      case 'saved':
        return SavedVideoRecord.fromJson(json);
      default:
...
class RawVideoRecord extends LocalVideoRecord {
  ...
  factory RawVideoRecord.fromJson(Map<String, dynamic> json) {
    final record = _$RawVideoRecordFromJson(json);
    return record.copyWith(
      videoClipConfigReqVo:
          ClipConfigCodec.normalize(
                record.videoClipConfigReqVo,
                record.sportType,
              )
              as VideoClipConfigReqVo,
    );
  }
...
class ProcessVideoRecord extends LocalVideoRecord {
  ...
  factory ProcessVideoRecord.fromJson(Map<String, dynamic> json) {
    final record = _$ProcessVideoRecordFromJson(json);
    return record.copyWith(
      videoClipConfigReqVo:
          ClipConfigCodec.normalize(
                record.videoClipConfigReqVo,
...
@JsonSerializable()
class SavedVideoRecord extends LocalVideoRecord {
  double duration;
  int fileSize;
  ...
  SavedVideoRecord({
    ...
    super.updatedAt,
         ...
         type: VideoRecordTypeEnum.saved,
         processStatus: LocalVideoProcessStatusEnum.completed,
       );

  factory SavedVideoRecord.fromJson(Map<String, dynamic> json) =>
      _$SavedVideoRecordFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$SavedVideoRecordToJson(this);

  SavedVideoRecord copyWith({
    String? id,
    SportType? sportType,
    String? filePath,
    String? thumbnailPath,
    ...
    final result = SavedVideoRecord(
      ...
      videoProcessType: videoProcessType ?? this.videoProcessType,
