...
class VideoInfoRespVO {
  ...
  factory VideoInfoRespVO.fromJson(Map<String, dynamic> json) {
    final video = _$VideoInfoRespVOFromJson(json);
    video.config = ClipConfigCodec.normalize(video.config, video.sportType);
    return video;
  }
...
class VideoProcessRecordVO {
  ...
  factory VideoProcessRecordVO.fromJson(Map<String, dynamic> json) {
    final record = _$VideoProcessRecordVOFromJson(json);
    record.videoClipConfigReqVo = ClipConfigCodec.normalize(
