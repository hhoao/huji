...
mixin _$MultiVideoPlayerState {
 ...
 int get currentTimeMs; VideoPlaybackItem? get currentItem; List<VideoPlaybackItem> get items; dynamic get currentVideoController; double get volume; double get playbackSpeed; bool get isLooping;// 播放状态字段
...
@useResult
$Res call({
 int currentTimeMs, VideoPlaybackItem? currentItem, List<VideoPlaybackItem> items, dynamic currentVideoController, double volume, double playbackSpeed, bool isLooping, bool isLoading, bool isPlaying, bool isFullscreen, bool isContinuousPlayback
});
...
as dynamic,volume: null == volume ? _self.volume : volume // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentTimeMs,  VideoPlaybackItem? currentItem,  List<VideoPlaybackItem> items,  dynamic currentVideoController,  double volume,  double playbackSpeed,  bool isLooping,  bool isLoading,  bool isPlaying,  bool isFullscreen,  bool isContinuousPlayback)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MultiVideoPlayerState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentTimeMs,  VideoPlaybackItem? currentItem,  List<VideoPlaybackItem> items,  dynamic currentVideoController,  double volume,  double playbackSpeed,  bool isLooping,  bool isLoading,  bool isPlaying,  bool isFullscreen,  bool isContinuousPlayback)  $default,) {final _that = this;
switch (_that) {
case _MultiVideoPlayerState():
return $default(_that.currentTimeMs,_that.currentItem,_that.items,_that.currentVideoController,_that.volume,_that.playbackSpeed,_that.isLooping,_that.isLoading,_that.isPlaying,_that.isFullscreen,_that.isContinuousPlayback);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentTimeMs,  VideoPlaybackItem? currentItem,  List<VideoPlaybackItem> items,  dynamic currentVideoController,  double volume,  double playbackSpeed,  bool isLooping,  bool isLoading,  bool isPlaying,  bool isFullscreen,  bool isContinuousPlayback)?  $default,) {final _that = this;
switch (_that) {
case _MultiVideoPlayerState() when $default != null:
return $default(_that.currentTimeMs,_that.currentItem,_that.items,_that.currentVideoController,_that.volume,_that.playbackSpeed,_that.isLooping,_that.isLoading,_that.isPlaying,_that.isFullscreen,_that.isContinuousPlayback);case _:
  return null;
...
@override@JsonKey() final  dynamic currentVideoController;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MultiVideoPlayerState&&(identical(other.currentTimeMs, currentTimeMs) || other.currentTimeMs == currentTimeMs)&&(identical(other.currentItem, currentItem) || other.currentItem == currentItem)&&const DeepCollectionEquality().equals(other._items, _items)&&const DeepCollectionEquality().equals(other.currentVideoController, currentVideoController)&&(identical(other.volume, volume) || other.volume == volume)&&(identical(other.playbackSpeed, playbackSpeed) || other.playbackSpeed == playbackSpeed)&&(identical(other.isLooping, isLooping) || other.isLooping == isLooping)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isPlaying, isPlaying) || other.isPlaying == isPlaying)&&(identical(other.isFullscreen, isFullscreen) || other.isFullscreen == isFullscreen)&&(identical(other.isContinuousPlayback, isContinuousPlayback) || other.isContinuousPlayback == isContinuousPlayback));
}


@override
int get hashCode => Object.hash(runtimeType,currentTimeMs,currentItem,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(currentVideoController),volume,playbackSpeed,isLooping,isLoading,isPlaying,isFullscreen,isContinuousPlayback);
